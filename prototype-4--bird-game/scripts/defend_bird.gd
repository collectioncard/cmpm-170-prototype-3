...
const RANGE = 400  # how far the bird can be away from the player
...
func _process(_delta: float) -> void:
	PhysicsServer2D.area_set_param(get_viewport().find_world_2d().space, PhysicsServer2D.AREA_PARAM_GRAVITY, 1400);
